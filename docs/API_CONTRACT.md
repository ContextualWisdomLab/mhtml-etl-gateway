...
Released version `0.4.0` exposes deterministic, synchronous, local inspection,
schema-proposal, mapping, value-free catalog-manifest, and governed handoff
APIs. The package performs no database write through the catalog connector,
network request,
