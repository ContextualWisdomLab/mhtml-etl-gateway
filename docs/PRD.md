...
`/api/dbml/convert`, carries one reviewed table's allow-listed types and
...
3. `pg-erd-cloud`: current one-table DBML visualization handoff for reviewed
   proposals; future multi-table lineage and relationship contracts.
