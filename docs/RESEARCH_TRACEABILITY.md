...
| root `start`, first-body default, and required type | RFC 2387 plus verified erratum 5578 | deterministic root; diagnose enterprise missing type; reject mismatch |
...
| secure development | NIST SP 800-218 SSDF 1.1 | design decisions, provenance, vulnerability and environment controls |
...
| scheduled coding agent | OpenCode GitHub Action documentation | protected schedule, NIM auth, `share: false`, bounded write permissions |
