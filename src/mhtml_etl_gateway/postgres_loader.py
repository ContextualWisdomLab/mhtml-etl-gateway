...
def prepare_typed_rows(
    ...
    # Optimization: Hoist invariant lookups outside the inner loop.
    # CPython optimizes list comprehensions efficiently when the inner logic has minimal branches.
